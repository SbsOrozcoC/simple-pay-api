          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block ml-10">
              <div className="flex space-x-4">
                ...
                <a href="/subscription" className="text-gray-500 hover:text-gray-700 px-3 py-2 rounded-md text-sm font-medium">Suscripción</a>
                <a href="/panel" className="text-gray-500 hover:text-gray-700 px-3 py-2 rounded-md text-sm font-medium">Mi Panel</a>
              </div>
            </div>
          </div>
